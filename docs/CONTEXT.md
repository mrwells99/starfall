...
Latest Vanguard visual direction: exposed-head, dark-armored Vanguard with violet crystals and a **two-handed hammer**. **Stage 1 hammer is owner-approved and locked.** **Stage 2 torso/shoulders is built and polished** as a standalone review asset (~24k tris). **Stage 3 arms/hands is now built and visually reviewed as a separate static upper-body assembly**, with both hands around the actual hammer shaft — arms 8 batches / 27,436 tris; assembly 14 batches / 76,652 tris. No rig or gameplay integration. Next: owner review of carry/grip, then lower body (pelvis, legs, boots) and exposed head, full static review, rigging and integration. Read [`VANGUARD_ARMS_STUDY.md`](VANGUARD_ARMS_STUDY.md), then [`VANGUARD_TORSO_STUDY.md`](VANGUARD_TORSO_STUDY.md) and [`VANGUARD_HAMMER_STUDY.md`](VANGUARD_HAMMER_STUDY.md). Playable sword/shield Vanguard is intact. Original approved source assets were preserved; the assembly proposes a 0.8 hammer scale and calmer review-only crystal emission.
