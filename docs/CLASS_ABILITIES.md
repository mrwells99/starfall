...
Current implementation, September 8, 2026. Balance is provisional and needs human playtesting. Fulcrum has thirteen abilities (Starfall on Shift+6); other classes have twelve: 1–7 on the first bar and Shift+1–5 on the second. All slots can be rebound or moved in Edit HUD. Older layouts automatically gain missing abilities in empty slots.
...
| 6 | Mend | Restore up to 28.0 of your own health. For DPS classes, completing the cast also removes attached damage-over-time effects. Ground hazards can still hurt you. | 2.0s | 16.0s |
...
| Shift+4 | Mend | Restore up to 28.0 of your own health. For DPS classes, completing the cast also removes attached damage-over-time effects. Ground hazards can still hurt you. | 2.0s | 16.0s |
...
| Key | Ability | Effect | Cast | Cooldown |
| --- | --- | --- | --- | --- |
| 1 | Graviton | Deal 6 damage and apply an 8s DoT: 2 damage and 5 Meditation each second. Refreshes your own DoT without stacking. Collapse hits make your next Graviton instant. | 1.3s | 0.0s |
| 2 | Inward | Pull an enemy up to 8m toward your anchor. Requires an active anchor within 28m. Works through line-of-sight blockers; movement still stops at solid terrain. | Instant | 9.0s |
...
| Shift+2 | Outward | Push an enemy up to 8m away from your anchor. Requires an active anchor within 28m. Works through line-of-sight blockers; movement still stops at solid terrain. | Instant | 9.0s |
| Shift+3 | Heavy Orbit | Your anchor creates a 6m slowing field for 6s, even through line-of-sight blockers. Enemies inside move 45% slower. | Instant | 16.0s |
...
| Shift+5 | Collapse | Consume your anchor: deal 22 damage within 6m and root for up to 2s. At 75+ Meditation, stun for up to 3s instead; Meditation is not spent. Hitting any enemy makes your next Graviton instant. Works through line-of-sight blockers. Control shares diminishing returns. | 1.5s | 18.0s |
| Shift+6 | Starfall | Requires at least 50 Meditation. After a 2s cast, spend all Meditation to deal 20 + 0.4 damage per Meditation (40–60). Interrupted casts spend nothing. | 2.0s | 12.0s |

## Shared rules

Heat, Resolve and Meditation cap at 100. Graviton DoT ticks generate 5 Meditation each second for up to 8s. A successful Collapse grants one instant Graviton, retained until used. At 75+ Meditation Collapse stuns for 3s (subject to DR) without spending resource. Starfall requires 50+ and consumes all Meditation only on successful completion, dealing 20 + 0.4 per point. Completed DPS Mend clears all attached DoTs; standing in a ground hazard still deals damage. Each Luminary owns at most three stars. Brands, stars, anchors, defensive states, roots and ground fields are authoritative and replicated. Class resources reset between rounds and at duel boundaries. Stars expire after 30 seconds; brands after 10.

Gravity Anchor is placed up to 10m in the direction faced, swept against terrain and projected onto the floor. It lasts 20s. Anchor abilities need the caster within 28m. Inward and Outward also require anchor-to-target range. Inward, Outward, Collapse and Heavy Orbit ignore line-of-sight blockers; pushes and pulls still stop at solid collision. Non-anchor ground effects still require line of sight. Counterweight exchanges immediately after validation; both swept routes must be clear.
