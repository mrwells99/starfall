...
static func summary(ability: Dictionary) -> String:
	...
	var concepts := {
		...
		"inward": "Pull an enemy up to 8m toward your anchor. Target must be within 9m of the anchor (1.5 times Heavy Orbit's radius); caster and anchor must remain within 18m. Moving the enemy cancels their current cast and resets its global cooldown without a spell lockout. Grants a 4s buff for one instant, off-global-cooldown Collapse, consumed on use; its own cooldown still applies. Works through line-of-sight blockers; movement stops at solid terrain.",
		"outward": "Push an enemy up to 8m away from your anchor. Target must be within 9m of the anchor (1.5 times Heavy Orbit's radius); caster and anchor must remain within 18m. Moving the enemy cancels their current cast and resets its global cooldown without a spell lockout. Works through line-of-sight blockers; movement stops at solid terrain.",
