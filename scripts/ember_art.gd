extends RefCounted
# Blender-authored Ember presentation. Combat and collision remain on the actor.
const ASSET = preload("res://assets/characters/ember.glb")
var model: Node3D
...
func build(host: Node3D, team_color: Color) -> void:
 ...
 assert(player != null and skeleton != null, "Ember requires its imported skeleton and animations")
